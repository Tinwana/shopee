...
const ShopDescription: FC = () => {
  return (
    <section className="mt-20 bg-[#fff] rounded-sm shadow-sm">
      <div className="w-full border-t-[4px] border-[#ee4d2d]">
        <Container>
          <h2 className="font-bold text-[#000] mb-5 text-[.85rem] mt-12">
            SHOPEE - GÌ CŨNG CÓ, MUA HẾT Ở SHOPEE
          </h2>
          <p className="text-[9pt] text-[#000000] ">
          ...
          <p className="text-[9pt] text-[#000000] ">
            ...
            <span className="font-bold underline">Shopee Mall</span> chính là sự
            lựa chọn lí tưởng dành cho bạn. Để bạn có thể dễ dàng khi tìm hiểu
            và sử dụng sản phẩm,{" "}
            <span className="font-bold underline">
          ...
          <ul className="">
            ...
            <li className="">
              ...
              <span className="font-bold underline">Shopee Flash</span> Sale
          ...
          <p className="text-[9pt] text-[#000000] ">
            ...
            <span className="font-bold underline">
              mã giảm giá, Voucher Xtra{" "}
            </span>
            và{" "}
            <span className="font-bold underline">mã miễn phí vận chuyển</span>{" "}
            toàn quốc. Bên cạnh đó, Shopee cũng sẽ có những chiến dịch khuyến
            mãi lớn hằng năm như{" "}
            <span className="font-bold underline">
              Sale 2.2, Sale 3.3, Sale 4.4, Sale 5.5, Sale 6.6, Sale 7.7, Sale
              8.8, Sale 9.9, Sale 10.10, Sale 11.11, Sale Sinh Nhật 12.12;
              Khuyến Mãi Tết
            </span>{" "}
            thả ga săn sale quà Tết chất lượng. Đây là thời điểm để người mua
            ...
            vào các ngày trong tháng như Sale giữa tháng và Sale cuối tháng đón
            lương về, hoặc đón xem Shopee Live để săn hàng ngàn deal hời giá
            sốc.{" "}
          </p>
          <h2 className="font-bold text-[#000] my-5 text-[.85rem]   ">
          ...
          <p className="text-[9pt] text-[#000000] ">
            ...
            cho{" "}
            <span className="font-bold underline">hàng hiệu giảm đến 50%</span>.
            Cộng với mã giao hàng miễn phí, Shopee cũng có các mã giảm giá được
            phân phối mỗi tháng từ rất nhiều gian hàng chính hãng tham gia
          ...
          <p className="text-[9pt] text-[#000000] ">
            ...
            đến là{" "}
            <span className="font-bold underline">
              Shopee Home Club, Shopee Mum Club, Shopee Beauty Club và Shopee
              Book Club
            </span>{" "}
